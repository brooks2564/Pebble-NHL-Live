...
function processGameWeek(gameWeek, abbr) {
  ...
  msg[KEY_AWAY_WINS]    = awayRec.wins;
  msg[KEY_AWAY_LOSSES]  = awayRec.losses;
  msg[KEY_HOME_WINS]    = homeRec.wins;
  msg[KEY_HOME_LOSSES]  = homeRec.losses;
  msg[KEY_VIBRATE]      = gVibrate    ? 1 : 0;
  msg[KEY_AWAY_SHOTS]   = awayTeam.sog || 0;
  msg[KEY_HOME_SHOTS]   = homeTeam.sog || 0;
  msg[KEY_LAST_GOAL]    = "";
